...
if (shouldSilence) {
  ...
  console.log = (...args) => {
    ...
    if (message.includes('🔧 [') || // Background service init messages
        ...
        message.includes('✅ All background services initialized') ||
        ...
        message.includes('🔧 Initializing') || // Service initialization
        message.includes('✅ ') && message.includes('service initialized') || // Service init success
