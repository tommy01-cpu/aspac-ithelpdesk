...
export default function RequestForm() {
  ...
  const [formData, setFormData] = useState({
    ...
    priority: 'Low', // Changed from 'MEDIUM' to match template builder default
    mode: 'SELF_SERVICE_PORTAL',
    requestType: 'SERVICE', // Will be set based on template type
    status: 'For Approval', // Changed from 'OPEN' to match template builder default
    category: '',
    technician: '',
    subject: '',
    description: '',
    ...
    if (templateId) {
        ...
        const templates = {
          ...
          '1': {
            ...
            userViewConfig: {
              ...
              priority: { visible: false, editable: false, required: true, defaultValue: 'Low' },
              ...
              status: { visible: false, editable: false, required: true, defaultValue: 'For Approval' },
          ...
          '6': {
            ...
            userViewConfig: {
              requesterName: { visible: true, editable: false, required: true, defaultValue: 'John Doe' },
              priority: { visible: true, editable: true, required: true, defaultValue: 'Low' },
              mode: { visible: false, editable: false, required: true, defaultValue: 'SELF_SERVICE_PORTAL' },
              requestType: { visible: false, editable: false, required: true, defaultValue: 'SERVICE' },
              status: { visible: false, editable: false, required: true, defaultValue: 'For Approval' },
              category: { visible: false, editable: false, required: true },
      ...
      setTimeout(() => {
        ...
        setFormData(prev => ({
          ...
          // Don't hardcode status here - let it come from template config
