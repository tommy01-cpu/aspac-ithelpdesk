            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">View and manage your service requests</p>
                </div>
              </div>
          ...
          {filteredRequests.length === 0 ? (
            ...
            <div className="space-y-4">
              {filteredRequests.map((request) => (
                <Card key={request.id} className="bg-white/70 backdrop-blur-sm border-slate-200/60 shadow-sm hover:shadow-md transition-shadow">
