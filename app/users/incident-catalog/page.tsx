...
import { AlertTriangle, Tags, ChevronDown, ChevronUp, Search, Clock, AlertCircle, Bug } from 'lucide-react';
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <p className="text-slate-600 mb-6">Report issues and incidents that need immediate attention</p>
            ...
            <div key={category.id} className="bg-white rounded-lg border border-slate-200 shadow-sm">
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center p-2">
                    {category.icon ? (
                      <img 
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-1">
                      ...
                      <Badge variant="outline" className="text-xs">
                        {categoryIncidents[category.id]?.length || 0} incident types
                      </Badge>
                      {category.isActive && (
                ...
                <div className="border-t border-slate-200 bg-slate-50">
                  <div className="p-6">
                    <h4 className="font-medium text-slate-900 mb-4">
                      Incident Types ({categoryIncidents[category.id]?.length || 0})
                    </h4>
                              ...
                              <div className="flex items-center gap-4 flex-1">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2 mb-1">
                                    ...
                                    {incident.isUrgent && (
                                      <Badge className="bg-red-100 text-red-800 text-xs status-badge">Urgent</Badge>
                                    )}
                                    {!incident.isActive && (
                              ...
                              <div className="flex items-center gap-2 ml-4">
                                {incident.templateId && (
                                  <Button
                                    variant="outline"
                                    size="sm"
                                    onClick={() => router.push(`/users/incident/preview/${incident.templateId}`)}
                                  >
                                    Preview
                                  </Button>
                                )}
