...
export default function EditSLAPage() {
  ...
  const slaId = searchParams?.get('id');
  ...
  // Load SLA data when component mounts
  useEffect(() => {
    if (slaId) {
      ...
      const mockSLA = {
        ...
        description: "Service level agreement for hardware requests",
        responseTime: "4 hours",
        resolutionTime: "48 hours"
      };

      // Parse the time strings and populate form
      const responseTimeParts = mockSLA.responseTime.split(' ');
      const resolutionTimeParts = mockSLA.resolutionTime.split(' ');

      setSlaForm(prev => ({
        ...prev,
        name: mockSLA.name,
        description: mockSLA.description,
        responseTime: {
          days: '',
          hours: responseTimeParts[0] || '',
          minutes: ''
        },
        resolutionTime: {
          days: resolutionTimeParts[0] || '',
          hours: '',
          minutes: ''
        }
      }));
  ...
  const handleSave = () => {
    console.log('Updating SLA:', slaId, slaForm);
    // Here you would typically update the SLA in your backend
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
                    Edit {slaType === 'service' ? 'Service' : 'Incident'} SLA
                  </h1>
                  <p className="text-xs text-gray-600">Modify service level agreements and escalation workflows</p>
                </div>
              </div>
        ...
        <div className="container mx-auto p-6">
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Edit {slaType === 'service' ? 'Service' : 'Incident'} SLA</CardTitle>
                <p className="text-slate-600 text-sm">Modify the SLA configuration and settings</p>
              </CardHeader>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <Label htmlFor="edit-match-all" className="text-sm">Match ALL of the following (AND)</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <input 
                            type="radio" 
                            ...
                            className="text-blue-600" 
                          />
                          <Label htmlFor="edit-match-any" className="text-sm">Match ANY of the following (OR)</Label>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2">
                      <Checkbox 
                        id="operationalHours"
                        checked={slaForm.operationalHours?.enabled || false}
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox 
                        id="excludeHolidays"
                        checked={slaForm.operationalHours?.excludeHolidays || false}
                        onCheckedChange={(checked) => setSlaForm(prev => ({
                          ...prev,
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox 
                        id="excludeWeekends"
                        checked={slaForm.operationalHours?.excludeWeekends || false}
                        onCheckedChange={(checked) => setSlaForm(prev => ({
                          ...prev,
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox 
                      ...
                      checked={slaForm.responseEscalation?.enabled || false}
                      onCheckedChange={(checked) => setSlaForm(prev => ({
                        ...prev,
                          ...
                          <div className="space-y-3">
                            ...
                            {slaForm.resolutionEscalation?.level2Enabled && (
                              <div className="ml-6 space-y-3 border-l-2 border-orange-200 pl-4">
                                <div className="grid grid-cols-3 gap-4">
                                  <div className="space-y-2">
                                    <Label htmlFor="edit-level2-days">Days</Label>
                                    <Input
                                      id="edit-level2-days"
                                      type="number"
                                  ...
                                  <div className="space-y-2">
                                    <Label htmlFor="edit-level2-hours">Hours</Label>
                                    <Input
                                      id="edit-level2-hours"
                                      type="number"
                                  ...
                                  <div className="space-y-2">
                                    <Label htmlFor="edit-level2-minutes">Minutes</Label>
                                    <Input
                                      id="edit-level2-minutes"
                                      type="number"
                          ...
                          <div className="space-y-3">
                            ...
                            {slaForm.resolutionEscalation?.level3Enabled && (
                              <div className="ml-6 space-y-3 border-l-2 border-red-200 pl-4">
                                <div className="grid grid-cols-3 gap-4">
                                  <div className="space-y-2">
                                    <Label htmlFor="edit-level3-days">Days</Label>
                                    <Input
                                      id="edit-level3-days"
                                      type="number"
                                  ...
                                  <div className="space-y-2">
                                    <Label htmlFor="edit-level3-hours">Hours</Label>
                                    <Input
                                      id="edit-level3-hours"
                                      type="number"
                                  ...
                                  <div className="space-y-2">
                                    <Label htmlFor="edit-level3-minutes">Minutes</Label>
                                    <Input
                                      id="edit-level3-minutes"
                                      type="number"
                          ...
                          <div className="space-y-3">
                            ...
                            {slaForm.resolutionEscalation?.level4Enabled && (
                              <div className="ml-6 space-y-3 border-l-2 border-purple-200 pl-4">
                                <div className="grid grid-cols-3 gap-4">
                                  <div className="space-y-2">
                                    <Label htmlFor="edit-level4-days">Days</Label>
                                    <Input
                                      id="edit-level4-days"
                                      type="number"
                                  ...
                                  <div className="space-y-2">
                                    <Label htmlFor="edit-level4-hours">Hours</Label>
                                    <Input
                                      id="edit-level4-hours"
                                      type="number"
                                  ...
                                  <div className="space-y-2">
                                    <Label htmlFor="edit-level4-minutes">Minutes</Label>
                                    <Input
                                      id="edit-level4-minutes"
                                      type="number"
